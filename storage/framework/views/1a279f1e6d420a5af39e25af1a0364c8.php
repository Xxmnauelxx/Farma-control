<?php $__env->startSection('title', 'Porveedor'); ?>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="text-align: center"><?php echo e($proveedor->telefono); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php if(file_exists($rutaImagen) && !is_dir($rutaImagen)): ?>
                                            <img src="<?php echo e(asset($proveedor->avatar)); ?>" class="img-fluid img-circle"
                                                style="width: 40px; cursor: none;">
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('img/proveedor.png')); ?>" class="img-fluid img-circle"
                                                style="width: 40px; cursor: none;">
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <button type="button" class="avatar btn btn-sm btn-info"
                                            data-id="<?php echo e($proveedor->id); ?>" data-nombre="<?php echo e($proveedor->nombre); ?>"
                                            data-avatar="<?php echo e(asset($proveedor->avatar ?? 'img/proveedor.png')); ?>">
                                            <i class="fas fa-image"></i>
                                        </button>

                                        <button class="editar-prov btn btn-sm btn-success" type="button"
                                            data-id="<?php echo e($proveedor->id); ?>" data-toggle="modal"
                                            data-target="#modalEditarproveedor">
                                            <i class="fas fa-pencil-alt"></i>
                                        </button>

                                        <button class="borrar btn btn-sm btn-danger"  data-id="<?php echo e($proveedor->id); ?>" data-nombre="<?php echo e($proveedor->nombre); ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('crear_proveedor')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        <img id='logoactual' src="<?php echo e(asset('img/proveedor.png')); ?>"
                    ...
                    <form action="<?php echo e(route('cambiar_foto_proveedor')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('actualizar_proveedor')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#proveedoresTable').on('click', '.avatar', function(e) {
                ...
                $('#logoactual').attr('src', avatar || "<?php echo e(asset('img/proveedor.png')); ?>");
            ...
            $('#proveedoresTable').on('click', '.editar-prov', function() {
                ...
                var url = "<?php echo e(route('extraer_datos', ['id' => ':id'])); ?>";
            ...
            $('#proveedoresTable').on('click','.borrar', function(){
                ...
                var url = "<?php echo e(route('eliminar_proveedor',['id'=>':id'])); ?>";
                url = url.replace(':id', id);
...
<?php echo $__env->make('Layouts.pantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxman\OneDrive\Desktop\farmacia_laravel10\resources\views/admin/proveedor/index.blade.php ENDPATH**/ ?>