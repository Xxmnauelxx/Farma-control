...
<body>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div class="text-center">
                                            ...
                                            <img src="<?php echo e(asset('img/logo2.png')); ?>" alt=""
                                                style="width: 70px; height:70px">
                                        </div>

                                        <div class="mt-4">
                                            <form action="<?php echo e(route('loginInicio')); ?>" method="POST" id="login-form">
                                                <?php echo csrf_field(); ?>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="<?php echo e(route('recuperar_pass')); ?>" class="text-muted">Olvido
                                                            Contraseña?</a>
                                                    </div>
                                                ...
                                                <div class="mt-4">
                                                    <?php if(!$rootExists): ?>
                                                        <a href="<?php echo e(route('registro')); ?>" class="btn btn-danger w-100"
    ...
    <script src="<?php echo e(asset('libs/feather-icons/feather.min.js')); ?>"></script>
    <script src="<?php echo e(asset('libs/feather-icons/feather.min.js')); ?>"></script>
    <script src="j<?php echo e(asset('libs/feather-icons/feather.min.js')); ?>"></script>
...
<?php /**PATH C:\Users\xxman\OneDrive\Desktop\farmacia_laravel10\resources\views/admin/login/login.blade.php ENDPATH**/ ?>