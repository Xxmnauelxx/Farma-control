...
<body>
    ...
    <div class="container">
        ...
        <p>
            <a href="<?php echo e($actionUrl); ?>" class="btn">Restablecer contraseña</a>
        </p>
        ...
        <p class="footer">© <?php echo e(date('Y')); ?> Mi Empresa. Todos los derechos reservados.</p>
    </div>
...
<?php /**PATH C:\Users\xxman\OneDrive\Desktop\farmacia_laravel10\resources\views/admin/emails/notificacion.blade.php ENDPATH**/ ?>