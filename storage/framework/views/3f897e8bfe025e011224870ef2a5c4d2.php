<?php $__env->startSection('title', 'Farmacia|Usuario'); ?>
                    ...
                    <table class="table table-hover" id="usuarios">
                        ...
                        <tbody style="text-align: center">
                            ...
                            <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $us): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="user-row-<?php echo e($us->id); ?>" style="text-align: center">
                                    <td style="text-align: center"><?php echo e($contador++); ?></td>
                                    <td style="text-align: left"><?php echo e($us->name); ?></td>
                                    <td style="text-align: center">
                                        <img src="<?php echo e($us->avatar ? asset('storage/profile_images/' . $us->avatar) : asset('img/default.jpg')); ?>"
                                            alt="Avatar"
                                            style="width: 50px; height: 50px; border-radius: 50%; margin-left: 5px;">
                                    </td>
                                    <td style="text-align: center"><?php echo e($us->email); ?></td>
                                    <td style="text-align: center">
                                        <span class="badge bg-primary"> <?php echo e($us->tipo->nombre); ?></span>
                                    </td>
                                    <td style="text-align: center">

                                        <?php echo e($us->created_at->format('Y-m-d')); ?>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <button type="button" class="ver btn btn-sm btn-info"
                                            data-id="<?php echo e($us->id); ?>"><i class="fas fa-eye"></i></button>

                                        <button type="button" class="editar btn btn-sm btn-warning" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal" data-id="<?php echo e($us->id); ?>">
                                            <i class="fas fa-user-edit"></i>
                                        </button>
                                        
                                        <?php if((auth()->user()->id_tipo === 1 || auth()->user()->id_tipo === 2) && $us->id_tipo !== 1): ?>
                                            <button type="button" data-id="<?php echo e($us->id); ?>"
                    ...
                    <form action="<?php echo e(route('saveuser')); ?>" method="POST">
                        ...
                        <div class="form-group m-2">
                            ...
                            <select name="id_tipo" id="id_tipo" class="form-control select2" style="width: 100%">
                                ...
                                <?php $__currentLoopData = $tipousuario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tip->id); ?>"><?php echo e($tip->nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo e(route('editar_usuario')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.ver', function() {
                ...
                var URL = "<?php echo e(route('verusuario', ['id' => ':id'])); ?>";
            ...
            $(document).on('click', '.editar', function() {
                ...
                var URL = "<?php echo e(route('editarus', ['id' => ':id'])); ?>";
                URL = URL.replace(':id', userId);
            ...
            $(document).on('click', '.eliminar', function() {
                ...
                var URL = "<?php echo e(route('eliminar', ['id' => ':id'])); ?>";
                URL = URL.replace(':id', userId);
...
<?php echo $__env->make('Layouts.pantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxman\OneDrive\Desktop\farmacia_laravel10\resources\views/admin/usuario/index.blade.php ENDPATH**/ ?>