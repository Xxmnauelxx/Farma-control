    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img id="avatar4" src="<?php echo e(asset('img/logo.jpg')); ?>" class="user-image img-circle"
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-header text-center bg-primary">
                            <img id="avatar4" src="<?php echo e(asset('img/logo.jpg')); ?>" class="img-circle"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="<?php echo e(route('home')); ?>" class="brand-link">
                <img src="<?php echo e(asset('img/logo.png')); ?>" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
...
<?php /**PATH C:\Users\zease\Desktop\farmacia_laravel10\resources\views/Layouts/pantilla.blade.php ENDPATH**/ ?>