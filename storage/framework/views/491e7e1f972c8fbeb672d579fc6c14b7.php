                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="tipo" id="tipo"
                                            ...
                                            <?php $__currentLoopData = $tipospr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="presentacion" id="presentacion"
                                            ...
                                            <?php $__currentLoopData = $presentaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presentacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($presentacion->id); ?>"><?php echo e($presentacion->nombre); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#formCrearProducto').on('submit', function(e) {
                ...
                var url = "<?php echo e(route('crear_productos')); ?>";
            ...
            function buscar_producto(consulta = '') {
                var url = "<?php echo e(route('buscar_productos')); ?>";
                $.ajax({
            ...
            $('#form-logo').submit(e => {
                ...
                var url = "<?php echo e(route('cambiar_avatar')); ?>";
            ...
            $('#formEditarProducto').on('submit', function(e) {
                ...
                // Asignamos la URL para la creación de productos usando la ruta definida en Laravel.
                var url = "<?php echo e(route('editar_productos')); ?>";
            ...
            $(document).on('click', '.borrar', function(e) {
                ...
                var URL = "<?php echo e(route('eliminar_producto', ['id' => ':id'])); ?>";
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            data: {
                                _token: "<?php echo e(csrf_token()); ?>" // Token CSRF para Laravel
                            },
                            success: function(response) {
            ...
            $(document).on('click', '#boton_reporte', (e) => {
                ...
                var url = "<?php echo e(route('reporte_productos_pdf')); ?>"; // Ruta del PDF
            ...
            $(document).on('click', '#boton_reporteExcel', (e) => {
                ...
                var url = "<?php echo e(route('reporte_productos_excel')); ?>";
...
<?php echo $__env->make('Layouts.pantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxman\OneDrive\Desktop\farmacia_laravel10\resources\views/admin/productos/index.blade.php ENDPATH**/ ?>