                ...
                <div class="animate__animated  animate__fadeInDown card-body table-responsive">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-12">
                            <a href="<?php echo e(route('mas_consulta')); ?>" class="info-box-link" title="Ver mas Informacion">
                                <div class="info-box">
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <a href="<?php echo e(route('mas_consulta')); ?>" class="info-box-link">
                                <div class="info-box">
    ...
    <script>
        $(document).ready(function() {
            ...
            function mostrar_consulta() {
                var url = "<?php echo e(route('ver_consulta')); ?>";
                $.post(url, {
            ...
            function listar_ventas() {
                var url = "<?php echo e(route('listar_ventas')); ?>";
                ...
                datatable = $('#tabla_venta').DataTable({
                    "ajax": {
                        ...
                        "method": "POST",
                        "data": function(d) {
                            d._token = "<?php echo e(csrf_token()); ?>"; // Enviar CSRF token
                        },
            ...
            $('#tabla_venta').on('click', '.imprimir', function() {
                ...
                let id = datos.codigo;
                let url = "<?php echo e(route('imprimir_venta', ['id' => ':id'])); ?>";
            ...
            $('#tabla_venta').on('click', '.ver', function() {
                let datos = datatable.row($(this).parents()).data();
                let id = datos.codigo;
                let url = "<?php echo e(route('ver_venta', ['id' => ':id'])); ?>";
            ...
            $('#tabla_venta').on('click', '.borrar', function() {
                let datos = datatable.row($(this).parents()).data();
                let id = datos.codigo;
                var url = "<?php echo e(route('borrar_venta', ['id' => ':id'])); ?>".replace(':id', id);
...
<?php echo $__env->make('Layouts.pantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxman\OneDrive\Desktop\farmacia_laravel10\resources\views/admin/venta/listaventa.blade.php ENDPATH**/ ?>