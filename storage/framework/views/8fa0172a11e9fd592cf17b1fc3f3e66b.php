                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $compras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="text-align:center"><?php echo e($compra->codigo); ?></td>
                                    <td style="text-align:center"><?php echo e($compra->fecha_compra); ?></td>
                                    <td style="text-align:center"><?php echo e($compra->fecha_entrega); ?></td>
                                    <td style="text-align:center"><?php echo e($compra->total); ?></td>
                                    <td style="text-align:center">
                                        <?php if($compra->estado == 'Cancelado'): ?>
                                            <span class="badge bg-warning"><?php echo e($compra->estado); ?></span>
                                        <?php else: ?>
                                            <span class="badge bg-danger"><?php echo e($compra->estado); ?></span>
                                        <?php endif; ?>
                                    </td>

                                    <td style="text-align:center"><?php echo e($compra->proveedor); ?></td>

                                    <td style="text-align:center">
                                        <button class="imprimir btn btn-secondary" data-id="<?php echo e($compra->id); ?>">
                                            <i class="fas fa-print"></i>
                                        </button>

                                        <button class="ver btn btn-primary" data-id="<?php echo e($compra->id); ?>" type="button"
                                            data-toggle="modal" data-bs-target="#vistacompra">
                                            <i class="fas fa-eye"></i>
                                        </button>

                                        
                                        <button class="editar btn btn-info" type="button" data-id="<?php echo e($compra->id); ?>"
                                            data-bs-toggle="modal" data-bs-target="#cambiarestado"
                                            <?php echo e($compra->estado == 'Cancelado' ? 'disabled' : ''); ?>>
    ...
    <div class="modal fade" id="cambiarestado">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('cambiarEstado')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            function rellenar_productos() {
                ...
                var url = "<?php echo e(route('llenar_producto')); ?>";
            ...
            function rellenar_estado_pago() {
                ...
                var url = "<?php echo e(route('rellenar_estados')); ?>"; // Utilizando la ruta definida en Laravel
            ...
            function rellenar_proveedores() {
                // Definimos la ruta que vamos a llamar en el controlador de Laravel
                var url = "<?php echo e(route('rellenar_proveedores')); ?>"; // Utilizando la ruta definida en Laravel
...
function actualizarTabla() {
    ...
    $('#precio_compra').val('');
            ...
            $(document).on('click', '.crear-compra', (e) => {
                ...
                var url = "<?php echo e(route('crear_compra')); ?>";
            ...
            $('#listarcompras').on('click', '.ver', function() {
                ...
                var url = "<?php echo e(route('extraer_lote_compra', ['id' => ':id'])); ?>";
            ...
            $('#listarcompras').on('click', '.editar', function() {
                ...
                var url = "<?php echo e(route('extraer_estados', ['id' => ':id'])); ?>";
            ...
            $('#listarcompras').on('click', '.imprimir', function() {
                ...
                var url = "<?php echo e(route('imprimir_compra', ['id' => ':id'])); ?>";
                url = url.replace(':id', id);
...
<?php echo $__env->make('Layouts.pantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxman\OneDrive\Desktop\farmacia_laravel10\resources\views/admin/compra/index.blade.php ENDPATH**/ ?>