    ...
    <script>
        $(document).ready(function() {
            ...
            async function venta_mes() {
                try {
                    let url =
                        "<?php echo e(route('venta_mes')); ?>"; // Asegúrate de que la ruta está bien definida en Laravel
            ...
            async function vendedor_mes() {
                try {
                    var url = "<?php echo e(route('vendedormes')); ?>";
            ...
            async function ventas_anual() {
                // URLS de las rutas
                const url_anual = "<?php echo e(route('ventas_anual')); ?>"; // Año actual y anterior
            ...
            async function producto_mas_vendido() {
                var url = "<?php echo e(route('producto_mas_vendido')); ?>";
                try {
                    const response = await fetch(url, {
                        method: 'GET',
                        headers: {
            ...
            async function cliente_mes() {
                var url = "<?php echo e(route('cliente_mes')); ?>";
                try {
                    const response = await fetch(url, {
                        method: 'GET',
                        headers: {
...
<?php echo $__env->make('Layouts.pantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxman\OneDrive\Desktop\farmacia_laravel10\resources\views/admin/venta/consulta.blade.php ENDPATH**/ ?>