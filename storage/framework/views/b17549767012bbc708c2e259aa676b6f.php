        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('crearLaboratorio')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 text-center">
                            ...
                            <div style="display: flex; justify-content: center;">
                                <img id="preview" src="<?php echo e(asset('img/default.jpg')); ?>" alt="Vista previa"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formEditarLaboratorio">
                        ...
                        <div class="mb-3 text-center">
                            <img id="fotoPreview" src="<?php echo e(asset('img/default.jpg')); ?>" alt="Vista previa"
    ...
    <script>
        function previewImage(event) {
            ...
            if (file) {
                ...
                preview.src = '<?php echo e(asset('default.png')); ?>'; // Restablece a la imagen por defecto
        ...
        $(document).ready(function() {
            ...
            function recargarTabla() {
                var URL = "<?php echo e(route('listarLaboratorios')); ?>";
                $.ajax({
                    url: URL,
                    type: 'GET',
                    success: function(data) {
                        ...
                        data.lab.forEach(function(item) {
                            const fotoUrl = item.foto_url ? item.foto_url :
                                '<?php echo e(asset('img/default.jpg')); ?>';
            ...
            $('#laboratorioTable').on('click', '.eliminar', function() {
                ...
                var URL = "<?php echo e(route('eliminarLaboratorio', ['id' => ':id'])); ?>";
            ...
            $('#laboratorioTable').on('click', '.editar', function() {
                ...
                var URL = "<?php echo e(route('datoslaboratorio', ['id' => ':id'])); ?>";
                URL = URL.replace(':id', labId);
                    ...
                    success: function(data) {
                        if (data.success) {
                            ...
                            $('#fotoPreview').attr('src', data.laboratorio.foto_url ? data
                                .laboratorio.foto_url : '<?php echo e(asset('img/default.jpg')); ?>');
            ...
            $('#formEditarLaboratorio').on('submit', function(e) {
                ...
                var URL = "<?php echo e(route('editarLabo', ['id' => ':id'])); ?>";
            ...
            $('#formCrearTipo').on('submit', function(e) {
                ...
                const formData = new FormData(this);
                var URL = "<?php echo e(route('crearTipoProd')); ?>";
            ...
            function recargarTablaTipo() {
                var URL = "<?php echo e(route('listartipo')); ?>";
                $.ajax({
                    url: URL,
                    type: 'GET',
                    success: function(data) {
            ...
            $('#tipoTable').on('click', '.editarTip', function() {
                ...
                var URL = "<?php echo e(route('datosTip', ['id' => ':id'])); ?>";
            ...
            $('#formEditarTipo').on('submit', function(e) {
                ...
                var URL = "<?php echo e(route('editarTipo', ['id' => ':id'])); ?>";
            ...
            $('#tipoTable').on('click', '.eliminarTip', function() {
                ...
                var URL = "<?php echo e(route('eliminarTipo', ['id' => ':id'])); ?>";
                URL = URL.replace(':id', tipoId);
            ...
            $('#formcrearPresentacion').on('submit', function(e) {
                ...
                const formData = new FormData(this);
                var URL = "<?php echo e(route('crearPresentacion')); ?>";
            ...
            function recargarTablapresentacion() {
                var URL = "<?php echo e(route('listarPresentacion')); ?>";
                $.ajax({
                    url: URL,
                    type: 'GET',
                    success: function(data) {
            ...
            $('#presentacionTable').on('click', '.editarPre', function() {
                ...
                var URL = "<?php echo e(route('datosPre', ['id' => ':id'])); ?>";
            ...
            $('#formEditarPresent').on('submit', function(e) {
                ...
                var URL = "<?php echo e(route('editarPre', ['id' => ':id'])); ?>";
                URL = URL.replace(':id', preId);
            ...
            $('#presentacionTable').on('click', '.eliminarPre', function() {
                ...
                var URL = "<?php echo e(route('eliminarPre', ['id' => ':id'])); ?>";
                URL = URL.replace(':id', preId);
...
<?php echo $__env->make('Layouts.pantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxman\OneDrive\Desktop\farmacia_laravel10\resources\views/admin/atributos/index.blade.php ENDPATH**/ ?>