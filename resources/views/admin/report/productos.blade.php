...
<body>
    <header class="clearfix">
        ...
        <div id="">
            <span style="color: rgb(2, 14, 244)">Fecha y Hora Impresion: </span> {{ now()->format('d/m/Y H:i:s') }}
        </div>
    </header>
        ...
        <table>
            ...
            <tbody>
                @foreach ($productos as $index => $producto)
                    <tr>
                        <td class="servic">{{ $index + 1 }}</td>
                        <td class="servic">{{ $producto->nombre }}</td>
                        <td class="servic">{{ $producto->concentracion }}</td>
                        <td class="servic">{{ $producto->adicional }}</td>
                        <td class="servic">{{ $producto->laboratorio }}</td>
                        <td class="servic">{{ $producto->presentacion }}</td>
                        <td class="servic">{{ $producto->tipo }}</td>
                        <td class="servic">{{ $producto->stock }}</td>
                        <td class="servic">{{ number_format($producto->precio, 2) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
